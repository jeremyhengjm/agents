#' @rdname sis_missing_cpf
#' @title Controlled particle filter for SIS model with missing data
#' @description Runs an controlled particle filter for SIS agent-based model with missing data
...
sis_missing_cpf <- function(model_config, observations, filter_config){
  # start timer
